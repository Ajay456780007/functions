...
class ALL_GRAPH_PLOT:
    ...
    def Load_Comp_data(self,DB):
        A=pd.read_csv(f"{os.getcwd()}/Analysis/Comparative_Analysis/{DB}/ACC_1.csv").values
        B=pd.read_csv(f"{os.getcwd()}/Analysis/Comparative_Analysis/{DB}/SEN_1.csv").values
        C=pd.read_csv(f"{os.getcwd()}/Analysis/Comparative_Analysis/{DB}/SPE_1.csv").values
        D=pd.read_csv(f"{os.getcwd()}/Analysis/Comparative_Analysis/{DB}/PRE_1.csv").values
        E=pd.read_csv(f"{os.getcwd()}/Analysis/Comparative_Analysis/{DB}/REC_1.csv").values
        F=pd.read_csv(f"{os.getcwd()}/Analysis/Comparative_Analysis/{DB}/F1score_1.csv").values
    ...
    def Comp_figure(self,DB,perf,x_label,y_label,colors,bar_width):
        ...
        df.index = Models
        print(colored(f'Comp_Analysis Bar Graph values of {y_label} saved as CSV', 'yellow'))
        ...
        if self.save:
            ...
            print(colored(f'Comp_Analysis Bar Graph Image of {y_label} saved', 'green'))
    ...
    def Comp_figure_Line(self,DB,perf,x_label,y_label,colors):
        ...
        df = pd.DataFrame(perf, columns=Percentages)
        df.index = Models
        print(colored(f'Comp_Analysis Line Graph values of {y_label} saved as CSV', 'yellow'))
        plt.figure(figsize=(12,8))
        for i in range(perf.shape[0]):
        ...
        if self.save:
            ...
            print(colored(f'Comp_Analysis Line Graph Image of {y_label} saved', 'green'))
    ...
    def load_perf_values(self,DB):
        ...
        A11 = pd.read_csv(f"Analysis/ROC_Analysis/Concated_epochs/{DB}/metrics_epochs_100.csv").values
        A22 = pd.read_csv(f"Analysis/ROC_Analysis/Concated_epochs/{DB}/metrics_epochs_200.csv").values
        A33 = pd.read_csv(f"Analysis/ROC_Analysis/Concated_epochs/{DB}/metrics_epochs_300.csv").values
        A44 = pd.read_csv(f"Analysis/ROC_Analysis/Concated_epochs/{DB}/metrics_epochs_400.csv").values
        A55 = pd.read_csv(f"Analysis/ROC_Analysis/Concated_epochs/{DB}/metrics_epochs_500.csv").values
    ...
    def perf_figure(self,DB,perf,x_label,y_label,colors,bar_width):
        ...
        df = pd.DataFrame(perf, columns=Percentages)
        df.index = Models
        print(colored(f'Perf_Analysis Bar Graph values of {y_label} saved as CSV', 'yellow'))
        ...
        if self.save:
            ...
            print(colored(f'Perf_Analysis Bar Graph Image of {y_label} saved', 'green'))
    ...
    def perf_figure_line(self,DB,perf,x_label,y_label,colors):
        ...
        df = pd.DataFrame(perf, columns=Percentages)
        df.index = Models
        print(colored(f'Perf_Analysis Line Graph values of {y_label} saved as CSV', 'yellow'))
        plt.figure(figsize=(12, 6))
        for i in range(perf.shape[0]):
            plt.plot(Percentages, perf[i], marker='o', linestyle="-", alpha=1, label=Models[i], color=colors[i])
        ...
        if self.save:
            ...
            print(colored(f'Perf_Analysis Line Graph Image of {y_label} saved', 'green'))
    ...
    def load_kf_values(self,DB):
        A = pd.read_csv(f"Analysis/KF_Analysis/{DB}/ACC_2.csv").values
        B = pd.read_csv(f"Analysis/KF_Analysis/{DB}/SEN_2.csv").values
        C = pd.read_csv(f"Analysis/KF_Analysis/{DB}/SPE_2.csv").values
        D = pd.read_csv(f"Analysis/KF_Analysis/{DB}/F1score_2.csv").values
        E = pd.read_csv(f"Analysis/KF_Analysis/{DB}/REC_2.csv").values
        F = pd.read_csv(f"Analysis/KF_Analysis/{DB}/PRE_2.csv").values
    ...
    def kf_figure(self,DB,perf,x_label,y_label,colors,bar_width):
        ...
        df.index = Models
        print(colored(f'KF_Analysis Bar Graph values of {y_label} saved as CSV', 'yellow'))
        plt.figure(figsize=(12,8))
        for i in range(perf.shape[0]):
            plt.bar(x + i * bar_width, perf[i], width=bar_width, label=Models[i], color=colors[i], alpha=1)
        center_shift = (perf.shape[0] * bar_width) / 2 - bar_width / 2
        ...
        if self.save:
            ...
            df.to_csv(f"Results/{DB}/Comparative_Analysis/Bar/{y_label}__Graph.csv")
            plt.savefig(f"Results/{DB}/Comparative_Analysis/Bar/{y_label}_Graph.png", dpi=600)
            print(colored(f'KF_Analysis Bar Graph Image of {y_label} saved', 'green'))
    ...
    def kf_figure_line(self,DB,perf,x_label,y_label,colors):
        ...
        df = pd.DataFrame(perf, columns=folds)
        df.index = Models
        print(colored(f'KF_Analysis Line Graph values of {y_label} saved as CSV', 'yellow'))
        plt.figure(figsize=(12,8))
        for i in range(perf.shape[0]):
        ...
        if self.save:
            ...
            print(colored(f'KF_Analysis Line Graph Image of {y_label} saved', 'green'))
    ...
    def Load_Performance_ROC_values(self, DB):
        ...
        epoch_files = ["metrics_epochs_100.csv", "metrics_epochs_200.csv",
                       "metrics_epochs_300.csv", "metrics_epochs_400.csv",
        ...
        for file in epoch_files:
            data = pd.read_csv(os.path.join(base_path, file))  # shape: (8, 6)

            # Get the last two rows: TPR (row -2) and FPR (row -1)
            num_rows = data.shape[0]
            TPR = data.iloc[num_rows - 2].values.astype(float)
            FPR = data.iloc[num_rows - 1].values.astype(float)
